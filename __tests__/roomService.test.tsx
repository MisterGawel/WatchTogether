...
describe('createRoom - Validation', () => {
  it('should reject when room name is empty', async () => {
    ...
    // Act & Assert
    await expect(createRoom(emptyName, communityId, adminId))
      .rejects
      .toThrow('Le nom de la room ne peut pas être vide !');
  });
  ...
  it('should reject when room name is only whitespace', async () => {
    ...
    // Act & Assert
    await expect(createRoom(whitespaceName, communityId, adminId))
      .rejects
      .toThrow('Le nom de la room ne peut pas être vide !');
  });
