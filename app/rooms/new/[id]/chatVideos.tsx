...
export default function ChatVideos({
	...
	return (
		<div className="flex flex-col h-full">
			<h1 className="p-4 text-xl font-bold text-center bg-gray-100 shadow-md dark:bg-gray-800">
			...
			<div className="flex-grow p-4 space-y-4 overflow-y-auto bg-white dark:bg-gray-900">
				{viewMode === 'history'
					? messages.map((msg) => (
							<Card
								key={msg.id}
								className="relative p-4 dark:bg-gray-800"
							>
								...
								>
									...
									{msg.text.length > MAX_LENGTH && (
										<Button
											...
											className="inline-flex items-center p-0 ml-2 text-sm text-blue-500 underline dark:text-blue-400"
										>
											{isMessageExpanded
												? 'Voir moins'
												: 'Voir plus'}
			...
			{viewMode === 'chat' && (
				<div className="flex p-4 space-x-2 bg-white dark:bg-gray-800">
					<Input
						value={newMessage}
